...
namespace DevFreela.Application.Models
{
    public class ProjectViewModel
    {
        ...
        public static ProjectViewModel FromEntity(Project project)
            => new(project.Id, project.Title, project.Description,
                project.IdClient, project.IdFreelancer, project.Client.FullName,
                project.Freelancer.FullName, project.TotalCost, project.Comments);
    }
}
